...
export function CarCard({ car, onSelect }: { car: Car; onSelect: (c: Car) => void }) {
  return (
    <motion.button
      ...
      className="group relative flex flex-col overflow-hidden rounded-2xl border border-border bg-card text-left shadow-card transition-colors hover:border-primary/50"
    >
      <div className="relative aspect-[16/10] overflow-hidden bg-surface">
        ...
        <div className="absolute bottom-3 left-3 right-3 flex items-end justify-between">
          ...
          <div className="rounded-lg bg-gradient-red px-3 py-1.5 text-sm font-bold text-primary-foreground shadow-glow">
